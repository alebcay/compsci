...
void input() {
    for (int i=0; i<3; i++) {
        cout << "Enter a name for Student " << i + 1 << " (limit 10 chars in length): ";
    ...
    for (int i=0; i<3; i++) {
        for (int j=0; j<4;j++) {
            ...
            cout << "th grade (0-100 inclusive) ";
            }
            else if ((j + 1) % 10 == 1) {
                cout << "st grade (0-100 inclusive) ";
            }

            else if ((j + 1) % 10 == 2) {
                cout << "nd grade (0-100 inclusive) ";
            }

            else if ((j + 1) % 10 == 3) {
                cout << "rd grade (0-100 inclusive) ";
            }

            else {
                cout << "th grade (0-100 inclusives) ";
            }
...
void output () {
    cout << endl;
    cout << "Name" << "            " << "Grade 1" << "  " << "Grade 2" << "  " << "Grade 3" << "  " << "Grade 4" << "  " << "Average" << "  " << "Letter Grade" << endl;
    for (int i=0; i<3; i++) {
        int nameBuffer = 10 - nameArray[i].size();
        cout << nameArray[i];
